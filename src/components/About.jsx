    ...
    return (
        <div className='container mx-auto md:w-3/4 mt-8'>
            ...
            <div className='font text-center mb-8'>
                <span className='text-xs text-[#d2ad5f]'>----- Discover our history, values, and dedication to exceptional real estate service -----</span>
                <h2 className='text-3xl font-bold uppercase border-y-4 py-4'>Our Journey</h2>
            </div>
            <div className='container font mx-auto text-[#d2ad5f]'>
                <div className='font-semibold' style={{ backgroundImage: "url('https://images.unsplash.com/photo-1695278255455-9afc87008775?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')", backgroundSize: 'cover', backgroundPosition: 'center', padding: '40px', borderRadius: '8px', boxShadow: '0px 0px 20px rgba(0, 0, 0, 0.1)' }}>
                    <article className="max-w-2xl px-6 py-24 mx-auto space-y-12 dark:bg-gray-100 dark:text-gray-900">
                        <div className="w-full mx-auto space-y-4 text-center">
                            <p className="text-xs font-semibold tracking-wider mt-[-80px] uppercase">#EstateNest</p>
                            <h1 className="text-4xl font-bold leading-tight md:text-5xl">
                               Your Dream Home Awaits with EstateNest</h1>
                            <p className="text-sm dark:text-gray-600">by
                                <span className="font-semibold"> The EstateNest Team</span>
                                on
                                <time dateTime="2024-06-04"> June 4th, 2024</time>
                            </p>
                        </div>
                        <div className="dark:text-gray-800">
                            <p>Welcome to EstateNest, where we specialize in connecting you with the perfect home. Our mission is to provide exceptional real estate services that cater to your unique needs, ensuring a seamless and enjoyable home buying or selling experience.</p>
                            <p>With a team of dedicated professionals, we strive to deliver personalized service, expert market knowledge, and unwavering commitment to our clients. Join us on this journey and let us help you find your dream home.</p>
                        </div>
                        <div className="pt-12 border-t dark:border-gray-300">
                            <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                                <img  src="https://plus.unsplash.com/premium_photo-1682088396002-3b835b3fb106?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Team Member" className="self-center flex-shrink-0 w-[200px] h-[180px] border rounded-lg md:justify-self-start" style={{ backgroundColor: '#D1D5DB' }} />
                                <div className="flex flex-col">
                                    <h4 className="text-lg font-semibold">Meet Our Team</h4>
                                    <p className="dark:text-gray-600">Our team at EstateNest is dedicated to making your real estate dreams come true. With professionalism and passion, we work diligently to ensure that your journey to finding the perfect home is smooth and successful.</p>
                                </div>
                            </div>
